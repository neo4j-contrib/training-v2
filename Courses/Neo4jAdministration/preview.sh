...
asciidoctor -T s adoc/02_ManagingNeo4jInstances.adoc -o html/02_ManagingNeo4jInstances.html
...
#asciidoctor-pdf -T s adoc/02_ManagingNeo4jInstances.adoc -a allow-uri-read -a pdf-style=asciidoc-themes/02.yml -o pdf/02_ManagingNeo4jInstances.pdf
...
open html/02_ManagingNeo4jInstances.html
