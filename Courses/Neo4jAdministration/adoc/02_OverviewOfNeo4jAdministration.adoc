...
You should refer to the https://neo4j.com/docs/operations-manual/3.5/installation/[Neo4j Operations Manual] for instructions that are specific to your platform.
...
You should consult the https://neo4j.com/docs/operations-manual/3.5/[Neo4J Operations Manual] for more information about the installation requirements and procedures for your target platform, as well as details for Neo4j administration tasks. 

The https://neo4j.com/docs/developer-manual/current/#cypher-query-lang[Java Developer Manual ] covers using embedded mode for Neo4j and intended for developers.
