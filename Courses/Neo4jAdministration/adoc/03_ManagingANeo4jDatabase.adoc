...
[NOTE]
It is not possible to disable the HTTP connector. See the https://neo4j.com/docs/operations-manual/3.5/configuration/connectors/[connectors] section of the _Neo4j Operations Manual_ for more information.
