...
Now that you have installed the Neo4j Enterprise Edi
...
image::{imagedir}/L04-Ex1-create_cores.png[L04-Ex1-create_cores,width=800,align=center]
...
image::{imagedir}/L04-Ex1-containersCreated.png[L04-Ex1-containersCreated,width=800,align=center]
...
image::{imagedir}/L04-Ex1-AllCoreServersStarted.png[L04-Ex1-AllCoreServersStarted,width=1000,align=center]
...
image::{imagedir}/L04-Ex1-StopCores.png[L04-Ex1-StopCores,width=800,align=center]
...
image::{imagedir}/L04-Ex2-Core1IsLeader.png[L04-Ex2-Core1IsLeader,width=800,align=center]
...
image::{imagedir}/L04-Ex5_OneCore.png[L04-Ex5_OneCore,width=10000,align=center]
...
$( document ).ready(function() {
  Intercom('trackEvent','training-admin-view-part4');
});
</script>
++++
