...
This course introduces you to Neo4j and some of the most common administration tasks for a production Neo4j application.

This course is intended for administrators.

This self-paced training should take you 6-7 hours to complete if you perform all of the hands-on exercises in the course. 
