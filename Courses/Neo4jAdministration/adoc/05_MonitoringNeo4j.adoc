...
image::{imagedir}/L05-Ex3-KillConnection.png[L05-Ex3-KillConnection,width=800,align=center]
...
image::{imagedir}/L05-Ex4-HTTPLog.png[L05-Ex4-HTTPLog,width=1200,align=center]
...
image::{imagedir}/L05-Ex5-OutOfMemory.png[L05-Ex5-OutOfMemory,width=1000,align=center]
...
There are other options for collecting and viewing metrics which are described in the https://neo4j.com/docs/operations-manual/3.5/monitoring/metrics/[Neo4j Operations Manual] which include:
...
image::{imagedir}/L05-Ex6-CypherJMX1.png[L05-Ex6-CypherJMX1,width=800,align=center]

[start=3]
. Execute the Cypher statement for creating 1.3 million nodes: `FOREACH (i IN RANGE(1,1300000) | CREATE (:Person {name:'Person' + i}));`.
. Execute the Cypher statement shown above for querying for metrics.

image::{imagedir}/L05-Ex6-CypherJMX2.png[L05-Ex6-CypherJMX2,width=800,align=center]
