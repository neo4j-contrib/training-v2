...
You should refer to the https://neo4j.com/docs/operations-manual/current/installation/[Neo4j Operations Manual] for instructions that are specific to your platform.
