...
In this Exercise, you will modify the configuration for the stand-alone Neo4j instance that you have worked with prior to using Docker for Causal Clustering. This is the Neo4j database you imported, *crimes.db* previously when you imported the crime data. Then you will test that the authentication is working.
