...
:toc: left
:toclevels: 3
:prevsecttitle: Clusters
:prevsect: 4
:currsect: 5
:nextsecttitle: Monitoring
:nextsect: 6
:experimental:
:imagedir: ../img
...
For training purposes, we will use an LDAP provider for authentication, but in your real application, you will need to configure Neo4j for whatever provider you use for user authentcation.
...
image::{imagedir}/L05-Ex1-ldapsearch1.png[L05-Ex1-ldapsearch1,width=800,align=center]
...
image::{imagedir}/L05-Ex1-ldapsearch2.png[L05-Ex1-ldapsearch2,width=800,align=center]
...
image::{imagedir}/L05-Ex1-ldapsearch3.png[L05-Ex1-ldapsearch3,width=800,align=center]
...
image::{imagedir}/L05-Ex2-configureAuth.png[L05-Ex2-configureAuth,width=800,align=center]
...
image::{imagedir}/L05-Ex2-reader.png[L05-Ex2-reader,width=800,align=center]
...
image::{imagedir}/L05-Ex2-publisher.png[L05-Ex2-publisher,width=800,align=center]
...
Here are some guidelines that developers of your application should follow to ensure that data-in-transit is secure:

[square]
* Never include private data in a Cypher statement, but use parameters to avoid Cypher injections at runtime.
* ??? MORE HERE
...
image::{imagedir}/L05-Ex3-configure1.png[L05-Ex3-configure1,width=800,align=center]
...
image::{imagedir}/L05-Ex3-log1.png[ç,width=800,align=center]
...
image::{imagedir}/L05-Ex3-log2.png[L05-Ex3-log2,width=800,align=center]
