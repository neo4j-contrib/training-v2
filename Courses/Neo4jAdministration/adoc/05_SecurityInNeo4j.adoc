...
For _openLDAP_, you set up a stand-alone or core and read replica servers in a cluster for authentication using an LDAP Server, you configure the following:
