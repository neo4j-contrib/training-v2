...
quizesCookie = window.localStorage.getItem('com.neo4j.graphacademy.neo4jadministration.' + STAGE + '.quizes');
if (quizesCookie) {
...
function getQuizStatus() {
  return getQuizStatusRemote().then( function( value ) { 
    ...
    window.localStorage.setItem('com.neo4j.graphacademy.neo4jadministration.' + STAGE + '.quizes', JSON.stringify(quizesStatusL) );
