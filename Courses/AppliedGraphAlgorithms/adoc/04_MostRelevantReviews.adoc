...
In this section we'll learn how to use the Personalized PageRank algorithm to identify "trusted" users, and present reviews from those users when viewing reviews of businesses.

image::{imagedir}/codesandbox5.png[,width=700,align=center]

Next, copy the following command into the query pane of the Neo4j Browser and execute it:
...
. Complete the Neo4j Browser Guide section for "Relevant Reviews"
