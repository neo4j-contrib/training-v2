...
. In the *Get Started* tab of the Yelp Sandbox you just created, click the *Launch Browser* button to open a Neo4j Browser for the Yelp database. You will be using this Neo4j Browser window throughout this course.
...
. In CodeSandbox, edit the *.env* file in CodeSandbox, replacing the default environment variables with the credentials for your Yelp Neo4j Sandbox.
...
*Note*: The creation of the Yelp Sandbox has changed and you should use the link provided above for creating the Yelp Sandbox.
