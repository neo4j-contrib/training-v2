...
. Then select Business Search, providing entering *pizza* for the search text and selecting Restaurant for the category. You should see a list of restaurants that are relevant to that user.
. Try selecting a different user and then search for pizza restaurants. You should see a different set of restaurants.
