...
[square]
* Learn about the Category Hierarchy algorithm and how to use it in Neo4j
* Enhance our business reviews application using Category Hierarchy to improve business search
...
* Use Jaccard Similarity and Label Proagation to build a photo based business recommendation feature
...
* Have completed Intro to Neo4j training or have equal Cypher proficiency
