...
[frame="none", cols="^.^,<.^"]
|===
a|image::{imagedir}/GraphAlgorithms.png[GraphAlgorithm,width=300,align=center]
a|
...
[frame="none", cols="^.^,<.^"]
|===
a|image::{imagedir}/Neo4jTooling.png[Neo4jTooling,width=300,align=center]
a|
...
image::{imagedir}/Neo4jPlatform.png[Neo4jPlatform,600,400,align=center]
