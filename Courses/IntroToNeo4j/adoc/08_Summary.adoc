...
// Ryan? some condition to test if all quizzes answered correctly to display this. We can't assume the name they specified when they signed up for the course is the one they want on the certificate

Click http://xxx[here] to enter your information for your certificate.
