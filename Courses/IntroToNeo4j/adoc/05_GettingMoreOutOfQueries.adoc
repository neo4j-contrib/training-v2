...
A best practice is to create your queries using a single MATCH pattern. 
...
[.thumb]
image::{imagedir}/KeanuFriendsForHugo.png[KeanuFriendsForHugo,width=800]
...
|===
[red]#Here is the simplified syntax for how varying length patterns are specified in Cypher:#
//a|
|===
[cols="50,50"]
|===
