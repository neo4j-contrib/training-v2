...
Select the correct answer.
[%interactive]
- [ ] [.required-answer]#It is an excellent prototyping tool and good at tackling problems#
- [ ] [.required-answer]#LISP is powerful. The code or data distinction is weaker, so it feels more extensible than other programming languages which make it feels like a domain specific language#
- [ ] [.required-answer]#LISP is the best programming answer on earth#
