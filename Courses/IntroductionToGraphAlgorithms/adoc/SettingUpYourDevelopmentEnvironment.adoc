...
image:img/PluginsAppInstalled.png[PluginsAppInstalled,width=400]
...
. Start the database. Is should appear as follows:

image:img/YelpLoaded.png[YelpLoaded,width=150]
...
image:img/NEulerInstalled.png[NEulerInstalled,width=800]
...
[.thumb]
image:img/AfterNEulerLoad.png[AfterNEulerLoad,width=150]
