...
quizesCookie = Cookies.getJSON('com.neo4j.graphacademy.datascience.' + STAGE + '.quizes');
if (quizesCookie) {
...
function getQuizStatus() {
  return getQuizStatusRemote().then( function( value ) { 
    ...
    Cookies.set('com.neo4j.graphacademy.datascience.' + STAGE + '.quizes', JSON.stringify(quizesStatusL) );
