...
Put a browser guide here for people to try out the link prediction algorithms on their own

In the query edit pane of Neo4j Browser, execute the browser command: kbd:[:play link-prediction-exercises] and follow the instructions.
