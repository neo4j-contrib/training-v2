...
In the query edit pane of Neo4j Browser, execute the browser command: kbd:[:play data-science-exercises] and follow the instructions for Exercise 1.
...
++++
<a class="medium button-notebook" target="_blank" href="https://colab.research.google.com/github/mneedham/data-science-training/blob/online/04_Predictions.ipynb">Launch the Notebook!</a>
++++
