...
== Step 1: Download and uncompress the following files to your system prior to coming to class:
...
*Note:* If you have already installed Neo4j Desktop on your system, you can skip the rest of these setup instructions.
