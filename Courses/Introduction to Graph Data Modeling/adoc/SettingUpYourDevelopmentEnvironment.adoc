...
You  perform the exercises of this course using Neo4j Desktop (which you must install prior to coming to this class).

*Step 1*: Download and uncompress these files on your system:
