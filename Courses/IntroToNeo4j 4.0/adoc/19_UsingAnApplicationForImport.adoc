...
:currsect: 19
:nextsecttitle: Using neo4j-admin for Import
:nextsect: 20
:experimental:
:imagedir: ../img
...
Next, you will learn how to get started using Neo4j drivers to load data into the graph.
...
== *Exercise 18: Using APOC for importing data*
