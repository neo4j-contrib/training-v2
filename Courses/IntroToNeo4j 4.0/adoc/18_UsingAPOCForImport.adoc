...
== Using APOC to clear the database
...
Regardless of whether you are performing the creation of the _Movie_ and _Person_ nodes in a single pass, this type of denormalized data requires conditional processing.
That is, the type of relationship created depends on the value of the _personType_ field.
