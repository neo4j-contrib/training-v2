...
In addition to CSV, APOC procedures can be used to read other formats such as XML and JSON.
...
== Using APOC, Cypher and jdbc for importing data

APOC also has procedures that enable you to connect to a live RDBMS via jdbc to import data.
To perform this type of import, you must be very comfortable with the source data in the RDBMS.
...
- [ ] [.required-answer]#Cypher using APOC procedures#
