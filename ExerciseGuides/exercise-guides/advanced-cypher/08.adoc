...
In this exercise, you will gain more experience aggregating data with Cypher.

In this exercise, you will:

* *Exercise 8.1*: Remove all nodes and relationships from the database.
* *Exercise 8.2*: Temporarily modify the virtual memory used by Neo4j.
* *Exercise 8.3*: Attempt to load the denormalized data for movies and people.
