...
if [ "$1" == "publish" ]; then
  URL=guides.neo4j.com/advanced-cypher-exercises
  render https://$URL -a csv-url=https://guides.neo4j.com/advanced-cypher-exercises -a env-training
  ...
  URL=localhost:8001/advanced-cypher-exercises
