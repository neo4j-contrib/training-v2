...
| pass:a[<a play-topic='{guides}/03.html'>Exercise 3</a>] -- Working with UNWIND
...
| pass:a[<a play-topic='{guides}/08.html'>Exercise 8</a>] -- Aggregating data and working with lists and maps
...
| pass:a[<a play-topic='{guides}/14.html'>Exercise 14</a>] -- Getting started with the Query Log Analyzer
