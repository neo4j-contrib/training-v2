...
*Here is a query to count the number of nodes that are Person and Actor nodes.  Profile it and then modify this query to use the count store.*
...
*Here is a query to count the number of :DIRECTED relationships in the graph.  Profile it and then modify this query to use the count store.*
...
*Here is a query to count the number of :IS_GENRE relationships per movie in the graph.  Profile it and then modify this query to use size() rather than count().*
