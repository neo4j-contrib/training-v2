...
*Determine the size of your database.*

*Set the virtual memory and pagecache sizes in the configuration for your database, then restart the database.*
...
. Set parameters that will be used for the parameterized queries. The best reuse of the querycache is to use parameters.
