...
In this exercise, you performed and compared the execution of queries using Cypher for path traversal with the same queries using APOC procedures. In most cases APOC will out-perform Cypher, but this will not always be the case.
