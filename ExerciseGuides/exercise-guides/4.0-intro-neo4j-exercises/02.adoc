...
[.thumb]
image::{guides}/img/MoviesReleased2003_Nodes.png[MoviesReleased2003_Nodes,width=600]
...
[.thumb]
image::{guides}/img/MoviesReleased2003_Table.png[MoviesReleased2003_Table,width=500]
