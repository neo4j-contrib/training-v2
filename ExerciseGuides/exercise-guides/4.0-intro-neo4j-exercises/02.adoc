...
[.thumb]
image::{guides}/img/MoviesReleased2003_Nodes.png[MoviesReleased2003_Nodes,width=300]
...
[.thumb]
image::{guides}/img/MoviesReleased2006_titles.png[MoviesReleased2006_titles,width=400]
...
[.thumb]
image::{guides}/img/RetrieveTitleReleasedTagline.png[RetrieveTitleReleasedTagline,width=400]
...
[.thumb]
image::{guides}/img/UsingAliases.png[UsingAliases,width=400]
