...
If you have already installed *sdk* on your system, skip this step.

In a terminal window, follow these steps to install *sdk* on your system:
...
[.thumb]
image::{guides}/img/AfterAppImport.png[AfterAppImport,width=300]
