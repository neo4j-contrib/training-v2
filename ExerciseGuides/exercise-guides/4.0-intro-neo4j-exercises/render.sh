...
if [ "$1" == "publish" ]; then
  URL=guides.neo4j.com/4.0-intro-neo4j-exercises
  render https://$URL -a csv-url=https://guides.neo4j.com/4.0-intro-neo4j-exercises -a env-training
  ...
  URL=localhost:8001/4.0-intro-neo4j-exercises
