...
* *Exercise 10.2*: Create _DIRECTED_ relationships.
...
== Exercise 10.2: Create _DIRECTED_ relationships (Instructions)

*Create the _DIRECTED_ relationship between _Robert Zemeckis_ and the movie, _Forrest Gump_.*

== Exercise 10.2: Create _DIRECTED_ relationships (Solution)
