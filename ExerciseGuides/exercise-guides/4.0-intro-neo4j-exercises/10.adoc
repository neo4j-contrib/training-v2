...
image::{guides}/img/AfterExercise9.png[AfterExercise9,150,200, role=left]
...
[.thumb]
image::{guides}/img/ForrestGumpRelationships.png[ForrestGumpRelationships,width=600]
...
[.thumb]
image::{guides}/img/SchemaAfterAddingRelatiobnships.png[SchemaAfterAddingRelatiobnships,width=600]
...
[.thumb]
image::{guides}/img/UpdateGarySiniseRole.png[UpdateGarySiniseRole,width=5400]
