...
image:{guides}/img/InitialDatabase.png[InitialDatabase,150,200]
...
[.thumb]
image::{guides}/img/SeventiesActors.png[SeventiesActors,width=600]
...
[.thumb]
image::{guides}/img/ProducersThatAreNotDirectors.png[ProducersThatAreNotDirectors,width=600]
