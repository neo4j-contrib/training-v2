...
[.thumb]
image::{guides}/img/call_db.schema.png[call_db.schema,width=600]
...
[.thumb]
image::{guides}/img/SpeedRacerWriters.png[SpeedRacerWriters,width=500]
...
[.thumb]
image::{guides}/img/TomHanksMovies.png[TomHanksMovies,width=600]
...
[.thumb]
image::{guides}/img/TomHanksRelationshipTypes.png[TomHanksRelationshipTypes,width=500]
...
[.thumb]
image::{guides}/img/TomHanksRoles.png[TomHanksRoles,width=600]
