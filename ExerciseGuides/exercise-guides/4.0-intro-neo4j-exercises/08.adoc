...
* *Exercise 8.6*: Retrieve all actors that have not appeared in more than 3 movies.
...
== Exercise 8.6: Retrieve all actors that have not appeared in more than 3 movies (Instructions)

*Retrieve all actors that have not appeared in more than 3 movies. Return their names and list of movies.*

== Exercise 8.6: Retrieve all actors that have not appeared in more than 3 movies (Solution)
