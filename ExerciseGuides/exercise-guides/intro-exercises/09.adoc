= Exercise 9
== Exercise 9: Merging Data in the Graph (Preparations)
...
image::{guides}/img/AfterExercise08.png[After exercise 10,200,200, role=left]

If your database does not have this number of nodes and relationships, you can use the script below to reset it:

[source, cypher]
----
include::scripts/AfterExercise08.cypher[]
----


== Exercise 9: Merging Data in the Graph (Overview)
...
* *Exercise 9.1*: Use `MERGE` to create a _Movie_ node.
* *Exercise 9.2*: Use `MERGE` to update a node.
* *Exercise 9.3*: Use `MERGE` to create a _Production_ node.
* *Exercise 9.4*: Find all labels for nodes with a property value.
* *Exercise 9.5*: Use `MERGE` to update a _Production_ node.
* *Exercise 9.6*: Use `MERGE` to add a label to a node.
* *Exercise 9.7*: Use `MERGE` to create two nodes and a single relationship.
* *Exercise 9.8*: Use the same `MERGE` statement to attempt to create two nodes and a single relationship.
* *Exercise 9.9*: Find the correct _Person_ node to delete.
* *Exercise 9.10*: Delete this _Person_ node, along with its relationships.
* *Exercise 9.11*: Find the correct _Forrest Gump_ node to delete.
* *Exercise 9.12*: Delete the _Forrest Gump_ node.
* *Exercise 9.13*: Use `MERGE` to create the _DIRECTED_ relationship.
* *Exercise 9.14*: Use `MERGE` to create the _ACTED_IN_ relationship.
* *Exercise 9.15*: Modify the _role_ relationship property.

Go to the next page to start this exercise.

== Exercise 9.1: Use `MERGE` to create a _Movie_ node (Instructions)
...
== Exercise 9.1: Use `MERGE` to create a _Movie_ node (Solution)
...
[.thumb]
image::{guides}/img/CreateForrestGump2.png[CreateForrestGump2,width=400]
...
== Exercise 9.2: Use `MERGE` to update a node (Instructions)
...
== Exercise 9.2: Use `MERGE` to update a node (Solution)
...
[.thumb]
image::{guides}/img/MergeForrestGump.png[MergeForrestGump,width=400]
...
== Exercise 9.3: Use `MERGE` to create a _Production_ node (Instructions)
...
== Exercise 9.3: Use `MERGE` to create a _Production_ node (Solution)
...
[.thumb]
image::{guides}/img/MergeProduction.png[MergeProduction,width=400]
...
== Exercise 9.4: Find all labels for nodes with a property value (Instructions)

*Query the graph to find labels for nodes with the title property, _Forrest Gump_.*

== Exercise 9.4: Find all labels for nodes with a property value (Solution)
...
[.thumb]
image::{guides}/img/AllForrestGumps.png[AllForrestGumps,width=400]
...
== Exercise 9.5: Use `MERGE` to update a _Production_ node (Instructions)
...
== Exercise 9.5: Use `MERGE` to update a _Production_ node (Solution)
...
[.thumb]
image::{guides}/img/AddCompany.png[AddCompany,width=400]
...
== Exercise 9.6: Use `MERGE` to add a label to a node (Instructions)

*Use `MERGE` to add the _OlderMovie_ label to the movie, _Forrest Gump_.*

== Exercise 9.6: Use `MERGE` to add a label to a node (Solution)
...
[.thumb]
image::{guides}/img/AddOlderMovieLabelToForrestGump.png[AddOlderMovieLabelToForrestGump,width=400]
...
== Exercise 9.7: Use `MERGE` to create two nodes and a single relationship (Instructions)
...
== Exercise 9.7: Use `MERGE` to create two nodes and a single relationship (Solution)

The result returned should be:

[.thumb]
image::{guides}/img/MergeNodesAndRelationships.png[MergeNodesAndRelationships,width=400]
...
== Exercise 9.8: Use the same `MERGE` statement to attempt to create two nodes and a single relationship (Instructions)
...
== Exercise 9.8: Use the same `MERGE` statement to attempt to create two nodes and a single relationship (Solution)
...
[.thumb]
image::{guides}/img/MergeNodesAndRelationships2.png[MergeNodesAndRelationships2,width=400]
...
== Exercise 9.9: Find the correct _Person_ node to delete (Instructions)
...
== Exercise 9.9: Find the correct _Person_ node to delete (Solution)
...
[.thumb]
image::{guides}/img/FindPersonNodeBeforeDelete.png[FindPersonNodeBeforeDelete,width=400]
...
== Exercise 9.10: Delete this _Person_ node, along with its relationships (Instructions)

*Delete this _Person_ node, along with its relationships.*

== Exercise 9.10: Delete this _Person_ node, along with its relationships (Solution)
...
[.thumb]
image::{guides}/img/DeletedExtraPerson.png[DeletedExtraPerson,width=400]
...
== Exercise 9.11: Find the correct _Forrest Gump_ node to delete (Instructions)
...
== Exercise 9.11: Find the correct _Forrest Gump_ node to delete (Solution)

The result returned should be:

[.thumb]
image::{guides}/img/ForrestGumpToDelete.png[ForrestGumpToDelete,width=400]
...
== Exercise 9.12: Delete the _Forrest Gump_ node (Instructions)

*Delete this _Forrest Gump_ node.*

It should have no relationships, but you can specify DETACH just to be certain.

== Exercise 9.12: Delete the _Forrest Gump_ node (Solution)
...
[.thumb]
image::{guides}/img/DeletedExtraForrestGump.png[DeletedExtraForrestGump,width=400]
...
== Exercise 9.13: Use `MERGE` to create the _DIRECTED_ relationship (Instructions)

*Use `MERGE` to create the _DIRECTED_ relationship between _Robert Zemeckis_ and  the _Movie_, _Forrest Gump_.*

== Exercise 9.13: Use `MERGE` to create the _DIRECTED_ relationship (Solution)
...
[.thumb]
image::{guides}/img/AddDirectedToForrestGump.png[AddDirectedToForrestGump,width=400]
...
== Exercise 9.14: Use `MERGE` to create the _ACTED_IN_ relationship (Instructions)
...
== Exercise 9.14: Use `MERGE` to create the _ACTED_IN_ relationship (Solution)
...
[.thumb]
image::{guides}/img/ActedInForrestGump.png[ActedInForrestGump,width=400]
...
== Exercise 9.15: Modify the _role_ relationship property (Instructions)
...
== Exercise 9.15: Modify the _role_ relationship property (Solution)
...
[.thumb]
image::{guides}/img/SetActedRoles.png[SetActedRoles,width=400]
...
== Exercise 9: Merging Data in the Graph (Summary)
