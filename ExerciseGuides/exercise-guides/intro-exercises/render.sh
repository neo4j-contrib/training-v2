...
if [ "$1" == "publish" ]; then
  URL=guides.neo4j.com/intro-exercises
  render https://$URL -a csv-url=https://guides.neo4j.com/intro-exercises -a env-training
  ...
  URL=localhost:8001/intro-exercises
