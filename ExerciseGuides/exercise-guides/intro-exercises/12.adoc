= Exercise 12
== Exercise 12: Working with Cypher data (Preparations)
...
== Exercise 12: Working with Cypher data (Overview)
...
* *Exercise 12.1*: Collect and use lists.
* *Exercise 12.2*: Collect a list.
* *Exercise 12.3*: Unwind a list.
* *Exercise 12.4*: Perform a calculation with the date type.

Go to the next page to start this exercise.

== Exercise 12.1: Collect and use lists (Instructions)
...
== Exercise 12.1: Collect and use lists (Solution)
...
== Exercise 12.2: Collect a list (Instructions)
...
== Exercise 12.2: Collect a list (Solution)
...
== Exercise 12.3: Unwind a list (Instructions)
...
== Exercise 12.3: Unwind a list (Solution)
...
== Exercise 12.4: Perform a calculation with the date type (Instructions)
...
== Exercise 12.4: Perform a calculation with the date type (Solution)
...
== Exercise 12: Working with Cypher data (Summary)
