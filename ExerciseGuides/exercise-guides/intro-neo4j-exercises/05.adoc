...
.*Before you begin:*
. Make sure you have completed Exercise 4. 
...
. Modify the query to retrieve all nodes that are followed by _James Thompson_ no matter how many hops are required.
...
*4. Modify the query to retrieve all nodes that are followed by _James Thompson_ no matter how many hops are required.*
...
. Retrieve all people who reviewed a movie, returning the list of reviewers an how many reviewers reviewed the movie.
...
*1. Retrieve all people who reviewed a movie, returning the list of reviewers an how many reviewers reviewed the movie.*
