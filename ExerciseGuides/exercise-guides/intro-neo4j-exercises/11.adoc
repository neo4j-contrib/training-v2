...
* *Exercise 11.1*: Use `MERGE` to create a _Movie_ node.
* *Exercise 11.2*: Use `MERGE` to update a node.
* *Exercise 11.3*: Use `MERGE` to create a _Production_ node.
* *Exercise 11.4*: Find all labels for nodes with a property value.
* *Exercise 11.5*: Use `MERGE` to update a _Production_ node.
...
* *Exercise 11.13*: Use `MERGE` to create the _DIRECTED_ relationship.
* *Exercise 11.14*: Use `MERGE` to create the _ACTED_IN_ relationship.
* *Exercise 11.15*: Modify the _role_ relationship property.

Go to the next page to start this exercise.

== Exercise 11.1: Use `MERGE` to create a _Movie_ node (Instructions)
...
== Exercise 11.1: Use `MERGE` to create a _Movie_ node (Solution)
...
== Exercise 11.2: Use `MERGE` to update a node (Instructions)
...
== Exercise 11.2: Use `MERGE` to update a node (Solution)
...
== Exercise 11.3: Use `MERGE` to create a _Production_ node (Instructions)
...
== Exercise 11.3: Use `MERGE` to create a _Production_ node (Solution)
...
== Exercise 11.4: Find all labels for nodes with a property value (Instructions)

*Query the graph to find labels for nodes with the title property, _Forrest Gump_.*

== Exercise 11.4: Find all labels for nodes with a property value (Solution)
...
== Exercise 11.5: Use `MERGE` to update a _Production_ node (Instructions)
...
== Exercise 11.5: Use `MERGE` to update a _Production_ node (Solution)
...
== Exercise 11.6: Use `MERGE` to add a label to a node (Instructions)

*Use `MERGE` to add the _OlderMovie_ label to the movie, _Forrest Gump_.*

== Exercise 11.6: Use `MERGE` to add a label to a node (Solution)
...
== Exercise 11.13: Use `MERGE` to create the _DIRECTED_ relationship (Instructions)

*Use `MERGE` to create the _DIRECTED_ relationship between _Robert Zemeckis_ and  the _Movie_, _Forrest Gump_.*

== Exercise 11.13: Use `MERGE` to create the _DIRECTED_ relationship (Solution)
...
== Exercise 11.14: Use `MERGE` to create the _ACTED_IN_ relationship (Instructions)
...
== Exercise 11.14: Use `MERGE` to create the _ACTED_IN_ relationship (Solution)
...
== Exercise 11.15: Modify the _role_ relationship property (Instructions)
...
== Exercise 11.15: Modify the _role_ relationship property (Solution)
