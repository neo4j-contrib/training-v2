...
.*Before you begin:*
. Make sure you have completed Exercise 1. 
...
*2. View the result pane as a table. In the result pane, click the table icon. You should see this table in the result pane:*
