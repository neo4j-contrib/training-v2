...
* *Exercise 6.2*: Modify the qyerty ti use the `DISTINCT` keyword to eliminate duplication.
* *Exercise 6.3*: Modify the query to eliminate more duplication.
* *Exercise 6.4*: Use the `ORDER BY` keyword to sort results returned.
...
== Exercise 6.2: Modify the query ti use the `DISTINCT` keyword to eliminate duplication. (Instructions)
...
== Exercise 6.2: Modify the query ti use the `DISTINCT` keyword to eliminate duplication. (Solution)
...
== Exercise 6.4: Use the `ORDER BY` keyword to sort results returned (Instructions)

*Modify the query that you just wrote to order the results returned so that the more recent years are displayed first.*

== Exercise 6.4: Use the `ORDER BY` keyword to sort results returned (Solution)
