...
* *Exercise 9.5*: Add the _roles_ properties to relationships.
* *Exercise 9.6*: Add a _research_ property to the _HELPED_ relationship.
* *Exercise 9.7*: View the current list of property keys in the graph.
* *Exercise 9.8*: View the current schema of the graph.
* *Exercise 9.9*: Query the graph to return the names and roles of actors in the movie, _Forrest Gump_.
* *Exercise 9.10*: Query the graph to retrieve information about any _HELPED_ relationships.
* *Exercise 9.11*: Modify the _role_ that _Gary Sinise_ played in the movie, _Forrest Gump_.
* *Exercise 9.12*: Remove the _research_ property from the _HELPED_ relationship.
...
== Exercise 9.5: Add the _roles_ properties to relationships (Instructions)
...
== Exercise 9.5: Add the _roles_ properties to relationships (Solution)
...
== Exercise 9.6: Add a _research_ property to the _HELPED_ relationship (Instructions)
...
== Exercise 9.6: Add a _research_ property to the _HELPED_ relationship (Solution)
...
== Exercise 9.9: Query the graph to return the names and roles of actors in the movie, _Forrest Gump_ (Instructions)

*Query the graph to return the names and roles of actors in the movie, _Forrest Gump_.*

== Exercise 9.9: Query the graph to return the names and roles of actors in the movie, _Forrest Gump_ (Solution)
...
== Exercise 9.10: Query the graph to retrieve information about any _HELPED_ relationships (Instructions)

*Query the graph to retrieve information about any _HELPED_ relationships.*

== Exercise 9.10: Query the graph to retrieve information about any _HELPED_ relationships (Solution)
...
== Exercise 9.11: Modify the _role_ that _Gary Sinise_ played in the movie, _Forrest Gump_ (Instructions)
...
== Exercise 9.11: Modify the _role_ that _Gary Sinise_ played in the movie, _Forrest Gump_ (Solution)
...
== Exercise 9.12: Remove the _research_ property from the _HELPED_ relationship (Instructions)

*Remove the _research_ property from the _HELPED_ relationship from _Tom Hanks_ to _Gary Sinise_.*

== Exercise 9.12: Remove the _research_ property from the _HELPED_ relationship (Solution)
...
== Exercise 9.13: Query the graph to confirm that your modifications were made to the graph (Instructions)

*Query the graph to confirm that your modifications were made to the graph.*

== Exercise 9.13: Query the graph to confirm that your modifications were made to the graph (Solution)
