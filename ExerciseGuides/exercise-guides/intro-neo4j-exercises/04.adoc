...
* *Exercise 4.9*: Retrieve all _REVIEW_ relationships from the graph with filtered results.
...
[.thumb]
image::{guides}/img/TomCruiseMovies.png[TomCruiseMovies,width=500]
...
[.thumb]
image::{guides}/img/SeventiesActors.png[SeventiesActors,width=500]
...
[.thumb]
image::{guides}/img/MatrixYoungerActors.png[MatrixYoungerActors,width=500]
...
[.thumb]
image::{guides}/img/MatchMovies2000.png[MatchMovies2000,width=500]
...
----
MATCH (a)-[rel]->(m)
WHERE a:Person AND rel:WROTE AND m:Movie
RETURN a.name as Name, m.title as Movie
----

Or you can specify the labels inline:

[source, cypher]
----
MATCH (a:Person)-[rel:WROTE]->(m:Movie)
RETURN a.name as Name, m.title as Movie
----
...
[.thumb]
image::{guides}/img/MatchWritersWhere.png[MatchWritersWhere,width=600]
...
[.thumb]
image::{guides}/img/NoYearBorn.png[NoYearBorn,width=600]
...
[.thumb]
image::{guides}/img/RelationshipsWithRatings.png[RelationshipsWithRatings,width=600]
...
[.thumb]
image::{guides}/img/ActorsNamedJames.png[ActorsNamedJames,width=600]
...
[.thumb]
image::{guides}/img/ReviewsWithFun.png[ReviewsWithFun,width=600]
...
[.thumb]
image::{guides}/img/ProducersThatAreNotDirectors.png[ProducersThatAreNotDirectors,width=500]
...
[.thumb]
image::{guides}/img/ActorsAsDirectors.png[ActorsAsDirectors,width=600]
...
That is also why in the second query whoever we match to a1 cannot be bound to a2 as well, because the single :ACTED_IN relationship between the person and the movie may only be traversed once per path, and it was already used in the first pattern, so it cannot be used in the second part of the pattern. This has the consequence that a1 and a2 must be separate people.
...
[.thumb]
image::{guides}/img/MoviesInList.png[MoviesInList,width=500]
...
[.thumb]
image::{guides}/img/RoleNameIsMovieName.png[RoleNameIsMovieName,width=600]
