...
== Exercise 4.9: Retrieve all _REVIEW_ relationships from the graph with filtered results (Instructions)

*Retrieve all _REVIEW_ relationships from the graph where the _summary_ of the review contains the string _fun_, returning the movie title reviewed and the rating and summary of the relationship.*

*Hint:* You do not know what case the _fun_ string will be in the summary text.

== Exercise 4.9: Retrieve all _REVIEW_ relationships from the graph with filtered results (Solution)
...
== Exercise 4.9: Retrieve all _REVIEW_ relationships from the graph where the _summary_ of the review contains the string _fun_ (Taking it further - optional)
