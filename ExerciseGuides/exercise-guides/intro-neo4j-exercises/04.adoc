...
* *Exercise 4.2*: Retrieve all actors that were born in the 70's.
* *Exercise 4.3*: Retrieve the actors who acted in the movie _The Matrix_ who were born after 1960.
* *Exercise 4.4*: Retrieve all movies  released in 2000 by testing the node label and the released property.
* *Exercise 4.5*: Retrieve all people that wrote movies by testing the relationship between two nodes.
* *Exercise 4.6*: Retrieve all people in the graph that do not have a _born_ property.
* *Exercise 4.7*: Retrieve all people related to movies where the relationship has the _rating_ property.
* *Exercise 4.8*: Retrieve all actors whose name begins with _James_.
* *Exercise 4.9*: Retrieve all all _REVIEW_ relationships from the graph where the _summary_ of the review contains the string _fun_.
* *Exercise 4.10*: Retrieve all people who have produced a movie, but have not directed a movie.
* *Exercise 4.11*: Retrieve the movies and their actors where one of the actors also directed the movie.
* *Exercise 4.12*: Retrieve all movies that were released in the years 2000, 2004, and 2008.
...
== Exercise 4.2: Retrieve all actors that were born in the 70's (Instructions)

*Retrieve all actors that were born in the 70's and return their names and year born.*

== Exercise 4.2: Retrieve all actors that were born in the 70's (Solution)
...
== Exercise 4.4: Retrieve all movies  released in 2000 by testing the node label and the released property (Instructions)

*Retrieve all movies  released in 2000 by testing the node label and the released property, returning the movie titles.*

== Exercise 4.4: Retrieve all movies  released in 2000 by testing the node label and the released property (Solution)
...
== Exercise 4.6: Retrieve all people in the graph that do not have a _born_ property (Instructions)
...
== Exercise 4.6: Retrieve all people in the graph that do not have a _born_ property (Solution)
...
== Exercise 4.7: Retrieve all people related to movies where the relationship has the _rating_ property (Instructions)
...
== Exercise 4.7: Retrieve all people related to movies where the relationship has the _rating_ property (Solution)
...
== Exercise 4.9: Retrieve all all _REVIEW_ relationships from the graph where the _summary_ of the review contains the string _fun (Instructions)
...
== Exercise 4.9: Retrieve all all _REVIEW_ relationships from the graph where the _summary_ of the review contains the string _fun_ (Solution)
...
== Exercise 4.12: Retrieve all movies that were released in the years 2000, 2004, and 2008 (Instructions)
...
== Exercise 4.12: Retrieve all movies that were released in the years 2000, 2004, and 2008 (Solution)
