= Exercise 10
== Exercise 10: Deleting Nodes and Relationships (Preparations)
...
== Exercise 10: Deleting Nodes and Relationships (Overview)
...
* *Exercise 10.2*: Query the graph to confirm that the relationship has been deleted.
* *Exercise 10.3*: Query the graph to display _Forrest Gump_ and all of its relationships.
* *Exercise 10.4*: Try deleting the _Forrest Gump_ node without detaching its relationships.
* *Exercise 10.5*: Delete _Forrest Gump_, along with its relationships in the graph.
* *Exercise 10.6*: Query the graph to confirm that the _Forrest Gump_ node has been deleted.

Go to the next page to start this exercise.

== Exercise 10.1: Delete a relationship (Instructions)
...
== Exercise 10.1: Delete a relationship (Solution)
...
== Exercise 10.2: Query the graph to confirm that the relationship has been deleted (Instructions)

*Query the graph to confirm that the relationship no longer exists.* 

== Exercise 10.2: Query the graph to confirm that the relationship has been deleted (Solution)
...
== Exercise 10.3: Query the graph to display _Forrest Gump_ and all of its relationships (Instructions)

*Query the graph to display _Forrest Gump_ and all of its relationships.*

== Exercise 10.3: Query the graph to display _Forrest Gump_ and all of its relationships (Solution)
...
== Exercise 10.4: Try deleting the _Forrest Gump_ node without detaching its relationships (Instructions)
...
== Exercise 10.4: Try deleting the _Forrest Gump_ node without detaching its relationships (Solution)
...
== Exercise 10.5: Delete _Forrest Gump_, along with its relationships in the graph (Instructions)

*Delete _Forrest Gump_, along with its relationships in the graph.*

== Exercise 10.5: Delete _Forrest Gump_, along with its relationships in the graph (Solution)
...
== Exercise 10.6: Query the graph to confirm that the _Forrest Gump_ node has been deleted (Instructions)

*Query the graph to confirm that the _Forrest Gump_ node has been deleted.*

== Exercise 10.6: Query the graph to confirm that the _Forrest Gump_ node has been deleted (Solution)
...
== Exercise 10: Deleting Nodes and Relationships (Summary)
