...
* *Exercise 14.4*: Update _Person_ nodes to have a _born_ property.
...
== Exercise 14.1: Add a uniqueness constraint to the graph (Instructions)
...
== Exercise 14.1: Add a uniqueness constraint to the graph (Solution)
...
[.thumb]
image::{guides}/img/CreatePersonNameUnique.png[CreatePersonNameUnique,width=300]
...
== Exercise 14.2: Add an actor to the graph (Instructions)

*Add _Tom Hanks_ to the graph.*

== Exercise 14.2: Add an actor to the graph (Solution)
...
== Exercise 14.4: Update _Person_ nodes to have a _born_ property (Instructions)

*Update the existing _Person_ nodes so that you set the _born_ property to _0_ for any nodes that do not exist.*

== Exercise 14.4: Update _Person_ nodes to have a _born_ property (Solution)
...
[.thumb]
image::{guides}/img/CreateTomHanksFailed.png[CreateTomHanksFailed,width=300]
...
[.thumb]
image::{guides}/img/AddBornExistsConstraint.png[AddBornExistsConstraint,width=300]
...
== Exercise 14.7: Add an existence constraint to a relationship in the graph (Instructions)
...
== Exercise 14.7: Add an existence constraint to a relationship in the graph (Solution)
...
[.thumb]
image::{guides}/img/CreateRolesConstraintExists.png[CreateRolesConstraintExists,width=300]
...
== Exercise 14.8: Attempt to add a relationship that violates the constraint (Instructions)
...
== Exercise 14.8: Attempt to add a relationship that violates the constraint (Solution)
...
== Exercise 14.9: Add a node key to the graph (Instructions)
...
== Exercise 14.9: Add a node key to the graph (Solution)
...
[.thumb]
image::{guides}/img/AddNodeKey.png[AddNodeKey,width=300]
...
== Exercise 14.10: Add the movie node to the graph (Instructions)

*Add the movie, _Back to the Future_ with a _released_ value of _1985_ and a _tagline_ value of _Our future._.*

== Exercise 14.10: Add the movie node to the graph (Solution)
...
[.thumb]
image::{guides}/img/AddedBackToTheFuture1985.png[AddedBackToTheFuture1985,width=300]
...
== Exercise 14.11: Add a similar movie node with slightly different property values(Instructions)

*Add the movie, _Back to the Future_ with a _released_ value of _2018_ and a _tagline_ value of _The future is ours._.*

== Exercise 14.11: Add a similar movie node with slightly different property values (Solution)
...
[.thumb]
image::{guides}/img/AddedBackToTheFuture2018.png[AddedBackToTheFuture2018,width=300]
...
== Exercise 14.14: Drop an existence constrain (Instructions)

*Drop the constraint that requires the _ACTED_IN_ relationship to have a property, _roles_.*

== Exercise 14.14: Drop an existence constrain (Solution)
...
[.thumb]
image::{guides}/img/dropConstraintRoles.png[dropConstraintRoles,width=300]
