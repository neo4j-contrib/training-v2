= Exercise 8
== Exercise 8: Creating Nodes (Preparations)
...
== Exercise 8: Creating Nodes (Overview)
...
* *Exercise 8.1*: Create a _Movie_ node for the movie with the _title_, _Forrest Gump_.
* *Exercise 8.2*: Retrieve the node you just created by its _title_.
* *Exercise 8.3*: Create a _Person_ node for the person with the _name_, _Robin Wright_.
* *Exercise 8.4*: Retrieve the _Person_ node you just created by its _name_.
* *Exercise 8.5*: Add the label _OlderMovie_ to any _Movie_ node that was released before 2010.
* *Exercise 8.6*: Retrieve all older movie nodes to test that the label was indeed added to these nodes.
* *Exercise 8.7*: Add the label _Female_ to all _Person_ nodes that has a person whose name starts with _Robin_.
* *Exercise 8.8*: Retrieve all _Female_ nodes.
* *Exercise 8.9*: Remove the _Female_ label from the nodes that have this label.
* *Exercise 8.10*: View the current schema of the graph.
* *Exercise 8.11*: Add properties to the movie, _Forrest Gump_.
* *Exercise 8.12*: Retrieve this _OlderMovie_ node to confirm that the properties and label have been properly set.
* *Exercise 8.13*: Add the properties to the person, _Robin Wright_.
* *Exercise 8.14*: Retrieve an updated _Person_ node.
* *Exercise 8.15*: Remove the _lengthInMinutes_ property from the movie, _Forrest Gump_.
* *Exercise 8.16*: Retrieve the _Forrest Gump_ node to confirm that the property has been removed.
* *Exercise 8.17*: Remove the _birthPlace_ property from the person, _Robin Wright_.
* *Exercise 8.18*: Retrieve the _Robin Wright_ node to confirm that the property has been removed.

Go to the next page to start this exercise.

== Exercise 8.1: Create a _Movie_ node for the movie with the _title_, _Forrest Gump_ (Instructions)

*Create a _Movie_ node for the movie with the _title_, _Forrest Gump_.*

== Exercise 8.1: Create a _Movie_ node for the movie with the _title_, _Forrest Gump_ (Solution)
...
== Exercise 8.2: Retrieve the node you just created by its _title_ (Instructions)

*Retrieve the node you just created by its _title_.*


== Exercise 8.2: Retrieve the node you just created by its _title_ (Solution)
...
== Exercise 8.3: Create a _Person_ node for the person with the _name_, _Robin Wright_ (Instructions)

*Create a _Person_ node for the person with the _name_, _Robin Wright_.*


== Exercise 8.3: Create a _Person_ node for the person with the _name_, _Robin Wright_ (Solution)
...
== Exercise 8.4: Retrieve the _Person_ node you just created by its _name_ (Instructions)

*Retrieve the _Person_ node you just created by its _name_.*

== Exercise 8.4: Retrieve the _Person_ node you just created by its _name_ (Solution)
...
== Exercise 8.5: Add the label _OlderMovie_ to any _Movie_ node that was released before 2010 (Instructions)

*Add the label _OlderMovie_ to any _Movie_ node that was released before 2010.*

== Exercise 8.5: Add the label _OlderMovie_ to any _Movie_ node that was released before 2010 (Solution)
...
== Exercise 8.6: Retrieve all older movie nodes to test that the label was indeed added to these nodes (Instructions)

*Retrieve all older movie nodes to test that the label was indeed added to these nodes.*

== Exercise 8.6: Retrieve all older movie nodes to test that the label was indeed added to these nodes (Solution)
...
== Exercise 8.7: Add the label _Female_ to all _Person_ nodes that has a person whose name starts with _Robin_ (Instructions)

*Add the label _Female_ to all _Person_ nodes that has a person whose name starts with _Robin_.*

== Exercise 8.7: Add the label _Female_ to all _Person_ nodes that has a person whose name starts with _Robin_ (Solution)
...
== Exercise 8.8: Retrieve all _Female_ nodes (Instructions)

*Retrieve all _Female_ nodes*

== Exercise 8.8: Retrieve all _Female_ nodes (Solution)
...
== Exercise 8.9: Remove the _Female_ label from the nodes that have this label (Instructions)

*We've decided to not use the _Female_ label. Remove the _Female_ label from the nodes that have this label.*

== Exercise 8.9: Remove the _Female_ label from the nodes that have this label (Solution)
...
== Exercise 8.10: View the current schema of the graph (Instructions)

*View the current schema of the graph.*

== Exercise 8.10: View the current schema of the graph (Solution)
...
== Exercise 8.11: Add properties to the movie, _Forrest Gump_ (Instructions)
...
== Exercise 8.11: Add properties to the movie, _Forrest Gump_ (Solution)
...
== Exercise 8.12: Retrieve this _OlderMovie_ node to confirm that the properties and label have been properly set (Instructions)

*Retrieve this _OlderMovie_ node to confirm that the properties and label have been properly set.*

== Exercise 8.12: Retrieve this _OlderMovie_ node to confirm that the properties and label have been properly set (Solution)
...
== Exercise 8.13: Add the properties to the person, _Robin Wright_ (Instructions)
...
== Exercise 8.13: Add the properties to the person, _Robin Wright_ (Solution)
...
== Exercise 8.14: Retrieve an updated _Person_ node (Instructions)

*Retrieve this _Person_ node to confirm that the properties have been properly set.*

== Exercise 8.14: Retrieve an updated _Person_ node (Solution)
...
== Exercise 8.15: Remove the _lengthInMinutes_ property from the movie, _Forrest Gump_ (Instructions)
...
== Exercise 8.15: Remove the _lengthInMinutes_ property from the movie, _Forrest Gump_ (Solution)
...
== Exercise 8.16: Retrieve the _Forrest Gump_ node to confirm that the property has been removed (Instructions)

*Retrieve the _Forrest Gump_ node to confirm that the property has been removed.*

== Exercise 8.16: Retrieve the _Forrest Gump_ node to confirm that the property has been removed (Solution)
...
== Exercise 8.17: Remove the _birthPlace_ property from the person, _Robin Wright_ (Instructions)

*Remove the _birthPlace_ property from the person, _Robin Wright_.*

== Exercise 8.17: Remove the _birthPlace_ property from the person, _Robin Wright_ (Solution)
...
== Exercise 8.18: Retrieve the _Robin Wright_ node to confirm that the property has been removed (Instructions)

*Retrieve the _Robin Wright_ node to confirm that the property has been removed.*

== Exercise 8.18: Retrieve the _Robin Wright_ node to confirm that the property has been removed (Solution)
...
== Exercise 8: Creating Nodes (Taking it further - optional)
...
== Exercise 8: Creating Nodes (Summary)
