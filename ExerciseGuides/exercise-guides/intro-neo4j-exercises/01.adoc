...
.. For the Neo4j Browser application, ensure that _Enable multi-statement query editor_ is selected in the browser settings.
If you are using the Web interface for Neo4j Browser, this setting is assumed.
