...
== Exercise 1.1: Retrieve all nodes (Instructions)
...
== Exercise 1.1: Retrieve all nodes (Solutions)
...
== Exercise 1.2: Examine the _schema_ of your database (Solutions)
...
== Exercise 1.3: Retrieve all _Person_ nodes (Solutions)
...
== Exercise 1.4: Retrieve all _Movie_ nodes (Solutions)
