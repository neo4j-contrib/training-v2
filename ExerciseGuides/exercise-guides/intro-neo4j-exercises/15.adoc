...
.*Before you begin:*
. Make sure you have completed Exercise 14.
...
*Important:* This Cypher script will fail if your graph has any constraints defined as it creates the constraints you created in the previous exercise.
You must first drop any constraints in your graph before running this script.
Use `CALL db.constraints` to see if you have any constraints in the graph and simply prefix the constraint definition with `DROP`.
