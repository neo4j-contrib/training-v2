...
if [ "$1" == "publish" ]; then
  URL=guides.neo4j.com/neo4j-modeling-exercises
  render https://$URL -a csv-url=https://guides.neo4j.com/neo4j-modeling-exercises -a env-training
  ...
  URL=localhost:8001/neo4j-modeling-exercises
